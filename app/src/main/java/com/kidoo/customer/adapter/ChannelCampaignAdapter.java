...
public class ChannelCampaignAdapter extends BaseQuickAdapter<MatchBean, BaseViewHolder> {
    ...
    public ChannelCampaignAdapter(Context context, List<MatchBean> datas) {
