...
public class JoinTeamApi {

    public static Observable<KidooApiResult<ReturnNullBean>> joinTeamAction(String teamId) {
        ...
        Observable<KidooApiResult<ReturnNullBean>> observable = requset.call(kidooApiService.joinTeam(requset.getParams().urlParamsMap));
