...
public class QueryTeamDetailApi {
    ...
    public static Observable<KidooApiResult<TeamDetailResult>> queryDetailAction(String teamId) {
        ...
        Observable<KidooApiResult<TeamDetailResult>> observable = requset.call(kidooApiService.queryTeamDetail(requset.getParams().urlParamsMap));
