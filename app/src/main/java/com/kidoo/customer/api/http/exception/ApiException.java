...
package com.kidoo.customer.api.http.exception;
...
public class ApiException extends Exception {
    ...
    public static ApiException handleException(Throwable e) {
        ...
        if (e instanceof HttpException) {
            ...
            ex = new ApiException(e, String.valueOf(ERROR.UNKNOWNHOST_ERROR));
            ex.message = "无法解析该域名";
            return ex;
        } else if (e instanceof NullPointerException) {
            ex = new ApiException(e, String.valueOf(ERROR.NULLPOINTER_EXCEPTION));
