...
package com.kidoo.customer.api.http.request;

import android.content.Context;
import android.text.TextUtils;

import com.kidoo.customer.api.http.HttpManager;
import com.kidoo.customer.api.http.api.ApiService;
...
import com.kidoo.customer.api.http.interceptor.BaseDynamicInterceptor;
import com.kidoo.customer.api.http.interceptor.CacheInterceptor;
import com.kidoo.customer.api.http.interceptor.CacheInterceptorOffline;
import com.kidoo.customer.api.http.interceptor.HeadersInterceptor;
import com.kidoo.customer.api.http.interceptor.NoCacheInterceptor;
...
import static com.kidoo.customer.api.http.HttpManager.getRxCache;
...
public abstract class BaseRequest<R extends BaseRequest> {
    ...
    private OkHttpClient.Builder generateOkClient() {
        if (readTimeOut <= 0 && writeTimeOut <= 0 && connectTimeout <= 0 && sslParams == null
            ...
            OkHttpClient.Builder builder = HttpManager.getOkHttpClientBuilder();
            ...
            if (cookies.size() > 0) HttpManager.getCookieJar().addCookies(cookies);
    ...
    private RxCache.Builder generateRxCache() {
        ...
        switch (cacheMode) {
            ...
            case DEFAULT://使用Okhttp的缓存
                if (this.cache == null) {
                    File cacheDirectory = HttpManager.getCacheDirectory();
                    ...
                    this.cache = new Cache(cacheDirectory, Math.max(5 * 1024 * 1024, HttpManager.getCacheMaxSize()));
                }
