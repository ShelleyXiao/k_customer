...
//        Disposable queryBannersAction(HomeContract.Interactor.GetBannerCallback callback);
        ...
        Disposable queryNewsAction(int type, int pageSize, int pageNo,  HomeContract.Interactor.GetNewsCallback callback);

        Disposable queryList(int type, HomeContract.Interactor.Callback callback);
