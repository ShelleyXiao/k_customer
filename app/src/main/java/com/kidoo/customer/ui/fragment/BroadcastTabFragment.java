...
//
//            ArenDetailActivity.showArenDetail(getActivity(), mSelectChannelAIndex,
...
//        View view = LayoutInflater.from(getActivity()).inflate(R.layout.layout_map_view_marker, null, false);
