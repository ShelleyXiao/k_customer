...
import com.kidoo.customer.BuildConfig;
    ...
    public static class Config {
        private Config() {
            ...
            if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
                    && AppContext.context().getExternalCacheDir() != null)
                sDefaultDir = AppContext.context().getExternalCacheDir() + FILE_SEP + "log" + FILE_SEP;
            else {
                sDefaultDir = AppContext.context().getCacheDir() + FILE_SEP + "log" + FILE_SEP;
            }
        }
