...
public class TitleBar extends FrameLayout {
    ...
    private void init(AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        // Set Background
        setBackgroundColor(getResources().getColor(R.color.kidoo_gren));

        // Init padding
        setPadding(getLeft(), getTop() + UIHelper.getStatusBarHeight(getContext()), getRight(), getBottom());
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int minH = (int) (d * 36 + UIHelper.getStatusBarHeight(getContext()));
