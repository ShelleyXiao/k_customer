...
//    private final DraggableFlagView mDraggableFlagView;
    ...
    public FloatLayout(Context context, AttributeSet attrs) {
        ...
        LayoutInflater.from(context).inflate(R.layout.float_boardcast_btn_layout, this);
        //浮动窗口按钮
...
//        AnimationDrawable animationDrawable = (AnimationDrawable) mFloatView.getBackground();
//        animationDrawable.start();

        Glide.with(this).load(R.drawable.gb_yfs_btn).into(mFloatView);
    }
