        ...
        mTeacherGenderView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (View.GONE == mGenderView.getVisibility()) {
                    ...
                    mTeacherGenderText.setTextColor(mContext.getResources().getColor(R.color.kidoo_61d2fe));
                    mTeacherGenderArrorImage.setImageResource(R.drawable.ic_up_blue);

                } else {
                    mGenderView.setVisibility(View.GONE);
                    mTeacherGenderText.setTextColor(mContext.getResources().getColor(R.color.blue_grey_300));
                    mTeacherGenderArrorImage.setImageResource(R.drawable.ic_down);
                }

                mTypeView.setVisibility(View.GONE);
                mTypeText.setTextColor(mContext.getResources().getColor(R.color.blue_grey_300));
                mTypeArrorImage.setImageResource(R.drawable.ic_down);
            }
        });
        ...
        mCourseTypeView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (View.GONE == mTypeView.getVisibility()) {
                    ...
                    mTypeText.setTextColor(mContext.getResources().getColor(R.color.kidoo_61d2fe));
                    mTypeArrorImage.setImageResource(R.drawable.ic_up_blue);
