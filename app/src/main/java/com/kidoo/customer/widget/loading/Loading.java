 ...
 */
package com.kidoo.customer.widget.loading;
 ...
 * <p>
 * See {@link net.oschina.common.R.styleable#Loading_gAutoRun Attributes},
 * {@link net.oschina.common.R.styleable#Loading_gBackgroundColor Attributes},
 * {@link net.oschina.common.R.styleable#Loading_gBackgroundLineSize Attributes}
 * {@link net.oschina.common.R.styleable#Loading_gForegroundColor Attributes}
 * {@link net.oschina.common.R.styleable#Loading_gForegroundLineSize Attributes}
 * {@link net.oschina.common.R.styleable#Loading_gProgressFloat Attributes}
 * <p>
...
public class Loading extends View {
    ...
    private void init(AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        int fgColorId = a.getResourceId(R.styleable.Loading_gForegroundColor, R.color.kidoo_white_alpha_240);
            ...
            try {
                switch (type) {
                    ...
                    case "array":
                        ...
                        break;
                    default:
                        setForegroundColor(resource.getIntArray(net.oschina.common.R.array.g_default_loading_fg));
                        break;
                }
            } catch (Exception e) {
                setForegroundColor(resource.getIntArray(net.oschina.common.R.array.g_default_loading_fg));
    ...
    public void setProgressStyle() {
        ...
        drawable = new LoadingCircleDrawable(resources.getDimensionPixelOffset(net.oschina.common.R.dimen.g_loading_minSize),
                resources.getDimensionPixelOffset(net.oschina.common.R.dimen.g_loading_maxSize));
