package com.kidoo.customer.widget.tablayout;
...
//                canvas.drawRect(paddingLeft, height - mUnderlineHeight, mTabsContainer.getWidth() + paddingLeft, height, mRectPaint);
                canvas.drawRect(paddingLeft, height - mUnderlineHeight, paddingLeft + mIndicatorRect.left, height, mRectPaint);
                canvas.drawRect(paddingLeft + mIndicatorRect.right, height - mUnderlineHeight, mTabsContainer.getWidth() + paddingLeft, height, mRectPaint);
            } else {
...
//                canvas.drawPath(mTrianglePath, mTrianglePaint);
                ...
                mTrianglePaint.setStrokeWidth(mUnderlineHeight);
                canvas.drawLine(paddingLeft + mIndicatorRect.left, height,
                        paddingLeft + mIndicatorRect.left / 2 + mIndicatorRect.right / 2,
                        height - mIndicatorHeight,
                        mTrianglePaint);
                canvas.drawLine(paddingLeft + mIndicatorRect.left / 2 + mIndicatorRect.right / 2,
                        height - mIndicatorHeight,
