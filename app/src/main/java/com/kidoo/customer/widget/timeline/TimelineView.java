package com.kidoo.customer.widget.timeline;
...
public class TimelineView extends View {
    ...
    private void init(AttributeSet attrs) {
        ...
        mStartLine = typedArray.getDrawable(R.styleable.TimelineView_line);
        mEndLine = typedArray.getDrawable(R.styleable.TimelineView_line);
        mMarkerSize = typedArray.getDimensionPixelSize(R.styleable.TimelineView_markerSize, (int) TDevice.dipToPx(mContext.getResources(), 20f));
        mLineSize = typedArray.getDimensionPixelSize(R.styleable.TimelineView_lineSize, (int) TDevice.dipToPx(mContext.getResources(), 2f));
